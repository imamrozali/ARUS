...
Express.js adapter for ARUSJS framework. Enables gradual migration from Express to ARUS.
...
app.listen(3000, () => {
  console.log("Express with ARUSJS on port 3000");
});
```
